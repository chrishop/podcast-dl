...
optional arguments:
  ...
  -B FILE_NAME, --batch FILE_NAME         Put RSS URL's in a file to download them all at once
  
  -d DATE_FROM, --date-from DATE_FROM     the oldest you want your podcasts in the format dd/mm/yy
